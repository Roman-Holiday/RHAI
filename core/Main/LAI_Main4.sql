...
VALUES		('TRAIT_LEADER_MAJOR_CIV',	'TERRAIN_PLAINS_IMPROVEMENT_BATEY'),
			('TRAIT_LEADER_MAJOR_CIV',	'TERRAIN_PLAINS_HILLS_IMPROVEMENT_BATEY'),
...
VALUES		('TERRAIN_PLAINS_IMPROVEMENT_BATEY',		'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_VALID_TERRAIN', 'PLAYER_IS_NOT_AI'),
			('TERRAIN_PLAINS_HILLS_IMPROVEMENT_BATEY',	'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_VALID_TERRAIN', 'PLAYER_IS_NOT_AI'),
...
VALUES		('TERRAIN_PLAINS_IMPROVEMENT_BATEY',		'TerrainType',		'TERRAIN_PLAINS'),
			...
			('TERRAIN_PLAINS_HILLS_IMPROVEMENT_BATEY',	'TerrainType',		'TERRAIN_PLAINS_HILLS'),
			('TERRAIN_PLAINS_HILLS_IMPROVEMENT_BATEY',	'ImprovementType',	'IMPROVEMENT_BATEY'),
...
('MajorFavorBuildings',	'BUILDING_BANK',				0, -10),
