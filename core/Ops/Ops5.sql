...
UPDATE OpTeamRequirements SET MinNumber = 0, MaxNumber = 1 WHERE TeamName = 'City Attack Force' AND AiType = 'UNITTYPE_AIR_SIEGE'; -- def min 0, max 1, 3
...
('City Naval Attack Force', 'UNITTYPE_AIR_SIEGE', 			 0, 1), -- pvs 2
...
('Walled City Naval Attack Force', 'UNITTYPE_AIR_SIEGE',       0, 1, 				0, 1), -- pvs max 3
