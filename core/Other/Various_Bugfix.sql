...
-- 2. RH AA Per Instance	

-- AA -- Advanced Ballistics Only	
...
INSERT OR IGNORE INTO ProjectCompletionModifiers    (ProjectType,		ModifierId)  VALUES	
		...
		('PROJECT_OPERATION_IVY',					'RH_FREE_AI_AIR_DEFENCE_ADVANCED_BALLISTICS_HIGH_DIFF'), 
		...
		('PROJECT_LAUNCH_MARS_BASE',				'RH_FREE_AI_AIR_DEFENCE_ADVANCED_BALLISTICS_HIGH_DIFF'), 
		('PROJECT_LAUNCH_EXOPLANET_EXPEDITION',		'RH_FREE_AI_AIR_DEFENCE_ADVANCED_BALLISTICS_HIGH_DIFF'); 


--------------------------------------------------------------------------------------------------------------------------------------
-- Guidance Systems Only, New



INSERT OR IGNORE INTO BuildingModifiers (BuildingType, ModifierId) VALUES
('BUILDING_COAL_POWER_PLANT', 				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'),
('BUILDING_FOSSIL_FUEL_POWER_PLANT', 		'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'),
('BUILDING_POWER_PLANT', 					'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF');


INSERT OR IGNORE INTO BuildingModifiers (BuildingType, ModifierId) VALUES
('BUILDING_RESEARCH_LAB', 				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'), -- New

('BUILDING_MUSEUM_ARTIFACT', 			'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'), -- New
('BUILDING_MUSEUM_ART', 				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'), -- New

('BUILDING_BROADCAST_CENTER', 			'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'),
('BUILDING_FILM_STUDIO', 				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'),

('BUILDING_ESTADIO_DO_MARACANA', 			'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'),
...
INSERT OR IGNORE INTO DistrictModifiers (DistrictType, ModifierId) VALUES
('DISTRICT_CITY_CENTER', 				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'),

('DISTRICT_AERODROME', 				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF');


INSERT OR IGNORE INTO BuildingModifiers (BuildingType, ModifierId) VALUES
('BUILDING_SEAPORT', 						'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'),
('BUILDING_MILITARY_ACADEMY', 				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF');


INSERT OR IGNORE INTO ProjectCompletionModifiers    (ProjectType,		ModifierId)  VALUES	
		('PROJECT_MANHATTAN_PROJECT',				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'),  
		('PROJECT_OPERATION_IVY',					'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'), 
		('PROJECT_LAUNCH_EARTH_SATELLITE',			'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'), 
		('PROJECT_LAUNCH_MOON_LANDING',				'RH_FREE_AI_AIR_DEFENCE_GUIDANCE_SYSTEMS_HIGH_DIFF'), 
...
INSERT OR IGNORE INTO ProjectCompletionModifiers    (ProjectType,		ModifierId)  VALUES	
		...
		('PROJECT_OPERATION_IVY',					'RH_AI_GOLD_SIM_ANTI_AIR_ADVANCED_BALLISTICS'), 
		...
		('PROJECT_LAUNCH_MARS_BASE',				'RH_AI_GOLD_SIM_ANTI_AIR_ADVANCED_BALLISTICS'), 
		('PROJECT_LAUNCH_EXOPLANET_EXPEDITION',		'RH_AI_GOLD_SIM_ANTI_AIR_ADVANCED_BALLISTICS'); 



---------------------------------------------------------------------------------------------------
-- Gold Sim Guidance Systems

INSERT OR IGNORE INTO BuildingModifiers (BuildingType, ModifierId) VALUES

('BUILDING_COAL_POWER_PLANT', 				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),
('BUILDING_FOSSIL_FUEL_POWER_PLANT', 		'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),
('BUILDING_POWER_PLANT', 					'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS');


INSERT OR IGNORE INTO BuildingModifiers (BuildingType, ModifierId) VALUES
('BUILDING_RESEARCH_LAB', 				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'), -- New

('BUILDING_MUSEUM_ARTIFACT', 				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'), -- New
('BUILDING_MUSEUM_ART', 				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'), -- New

('BUILDING_BROADCAST_CENTER', 			'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),
('BUILDING_FILM_STUDIO', 				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),

('BUILDING_ESTADIO_DO_MARACANA', 			'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),
('BUILDING_AIRPORT', 						'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),
('BUILDING_HANGAR', 						'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS');

INSERT OR IGNORE INTO DistrictModifiers (DistrictType, ModifierId) VALUES
('DISTRICT_CITY_CENTER', 				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),

('DISTRICT_AERODROME', 				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS');


INSERT OR IGNORE INTO BuildingModifiers (BuildingType, ModifierId) VALUES
('BUILDING_SEAPORT', 						'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),
('BUILDING_MILITARY_ACADEMY', 				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS');


INSERT OR IGNORE INTO ProjectCompletionModifiers    (ProjectType,		ModifierId)  VALUES	
		('PROJECT_MANHATTAN_PROJECT',				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'),  
		('PROJECT_OPERATION_IVY',					'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'), 
		('PROJECT_LAUNCH_EARTH_SATELLITE',			'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'), 
		('PROJECT_LAUNCH_MOON_LANDING',				'RH_AI_GOLD_SIM_ANTI_AIR_GUIDANCE_SYSTEMS'), 
...
INSERT OR IGNORE INTO RequirementSetRequirements
		...
		('RH_AI_HAS_ADVANCED_BALLISTICS_HIGH_DIFF',							'RH_DISABLE_ON_GUIDANCE_SYSTEMS'),		-- New
...
INSERT OR IGNORE INTO Requirements (RequirementId, RequirementType, Inverse) VALUES
('RH_DISABLE_ON_GUIDANCE_SYSTEMS', 'REQUIREMENT_PLAYER_HAS_TECHNOLOGY', 1);


INSERT OR IGNORE INTO RequirementArguments
		(RequirementId,									Name,						Value) VALUES	
		('RH_DISABLE_ON_GUIDANCE_SYSTEMS',							'TechnologyType',			'TECH_GUIDANCE_SYSTEMS');
