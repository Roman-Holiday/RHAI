...
INSERT OR IGNORE INTO ModifierArguments  (ModifierId, Name, Value) VALUES	
		...
		('RH_MILITARY_PRODUCTION_MOD_S',							'Amount'   , 3),
...
('BUILDING_BASILIKOI_PAIDES', 		'RH_MILITARY_PRODUCTION_MOD_XL'),
('BUILDING_ORDU', 					'RH_MILITARY_PRODUCTION_MOD_XL'),


('BUILDING_TERRACOTTA_ARMY', 		'RH_MILITARY_PRODUCTION_MOD_XL');
...
INSERT OR IGNORE INTO ModifierArguments  (ModifierId, Name, Value) VALUES	
		...
		('RH_FOOD_EXT_MOD_XXL',							'Amount'   , 275),
		...
		('RH_FOOD_EXT_MOD_XS',							'Amount'   , 5),

		('RH_FOOD_EXT_MOD_XXS',		'YieldType', 		'YIELD_RH_FOOD_EXT'),
		('RH_FOOD_EXT_MOD_XXS',							'Amount'   , 2),
...
INSERT OR IGNORE INTO BeliefModifiers (BeliefType        ,ModifierId)   VALUES
('BELIEF_FEED_THE_WORLD',				'RH_FOOD_EXT_MOD_M'),
