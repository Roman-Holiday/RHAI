...
-- Germany
('Rh_Germany_Commerical_Hub_Adj', 		 'LOC_DISTRICT_RH_AI_COMMERCIAL_HUB', 'YIELD_RH_PLACEMENT', 240, 1, 			'TECHNOLOGY_RH_AI_GERMANY_ADJ', 'DISTRICT_HANSA'), -- pvs 3, 4, 7, 11
...
('Def_Industrial_Green_AQUEDUCT', 		 'LOC_DISTRICT_RH_AI_COMMERCIAL_HUB', 'YIELD_RH_PLACEMENT', 50, 1, 	'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_AQUEDUCT'), -- Encourage placement
('Def_Industrial_Green_DAM', 		 'LOC_DISTRICT_RH_AI_COMMERCIAL_HUB', 'YIELD_RH_PLACEMENT', 	50, 1, 	'TECHNOLOGY_RH_AI_MAIN', 		'DISTRICT_DAM'),   -- Encourage placement
...
('Rh_Aqe_Industrial_Zone',					 'LOC_DISTRICT_RH_AI_AQE_INDUSTRIAL_ZONE', 'YIELD_RH_PLACEMENT', 95, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_INDUSTRIAL_ZONE'), -- pvs 12, 18
('Rh_Dam_Industrial_Zone', 					 'LOC_DISTRICT_RH_AI_DAM_INDUSTRIAL_ZONE', 'YIELD_RH_PLACEMENT', 95, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_INDUSTRIAL_ZONE'), -- pvs 17
...
('Rh_Commerical_Temp',					 	'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 300, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_DIPLOMATIC_QUARTER'), -- new
('Rh_Theater_Temp',					 		'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 300, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_DIPLOMATIC_QUARTER'), -- new
...
('Rh_Holy_Site_Tundra_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_ANCIENT', 100, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_TUNDRA_MOUNTAIN'),
('Rh_Holy_Site_Desert_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_ANCIENT', 100, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_DESERT_MOUNTAIN');
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_Campus_Reef',							 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', 120, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_REEF'),
('Rh_Campus_Fissure',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', 120, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_GEOTHERMAL_FISSURE');
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_All_District_IKKIL_pref',						 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 300, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_IKKIL'); -- 50% Production
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_Preserve_FEATURE_CHOCOLATEHILLS',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 990, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_CHOCOLATEHILLS'),
('Rh_Preserve_FEATURE_PANTANAL',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 990, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_PANTANAL'), 
('Rh_Preserve_FEATURE_WHITEDESERT',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 850, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_WHITEDESERT'),

('Rh_Preserve_FEATURE_GOBUSTAN',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 990, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_GOBUSTAN'), -- 1 Production, 3 Culture

('Rh_Preserve_FEATURE_EYE_OF_THE_SAHARA',				'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 650, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_EYE_OF_THE_SAHARA'), -- 2 Production, 1 Science

('Rh_Preserve_FEATURE_CLIFFS_DOVER',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 950, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_CLIFFS_DOVER'); 
...
('Rh_All_District_Volcano_Dis_Campus',				 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', -50, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_VOLCANO');
