...
('Rh_Diplo_City_Centre', 					 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 30, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CITY_CENTER'), -- total 2
('Rh_Diplo_Campus', 						 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 30, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CAMPUS'), -- pvs 4
('Rh_Diplo_Theater', 						 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 15, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_THEATER'), -- pvs 1
('Rh_Diplo_Industrial', 						 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 15, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_INDUSTRIAL_ZONE'),
...
('Rh_Gov_Campus',							 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 20, 1, 'TECHNOLOGY_RH_AI_MAIN', 	'DISTRICT_CAMPUS'),


('Rh_Encampment_Temp',						 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_AT_WAR', 425, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'), -- pvs 175 placement, 275
('Rh_Encampment_Temp2',						 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_UNDER_ATTACK', 125, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'), -- pvs 90
('Rh_Encampment_Temp3',						 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_MILITARY_PRODUCTION', 580, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'), -- pvs 90, 325

('Rh_Entertainment_Temp',					 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 110, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'),


('Rh_Aero_City_Centre',						'LOC_DISTRICT_RH_AI_AERODROME_CITYCENTRE', 'YIELD_RH_PLACEMENT', 40, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CITY_CENTER'), -- pvs 19
('Rh_Spaceport_City_Centre',				'LOC_DISTRICT_RH_AI_SPACEPORT_CITYCENTRE', 'YIELD_RH_PLACEMENT', 75, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CITY_CENTER'), -- pvs 1, 2, 9, 25
