...
-- Germany
('Rh_Germany_Commerical_Hub_Adj', 		 'LOC_DISTRICT_RH_AI_COMMERCIAL_HUB', 'YIELD_RH_PLACEMENT', 45, 1, 			'TECHNOLOGY_RH_AI_GERMANY_ADJ', 'DISTRICT_HANSA'), -- pvs 3, 4, 7, 11
...
-- Campus Temp
('Rh_Campus_Grass_Mountain',				 		 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', 120, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_GRASS_MOUNTAIN'), -- Temp
('Rh_Campus_Plains_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', 120, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_PLAINS_MOUNTAIN'),
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_All_District_IKKIL_pref',						 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 25, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_IKKIL'); -- 50% Production
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_Preserve_FEATURE_CHOCOLATEHILLS',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 465, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_CHOCOLATEHILLS'),
('Rh_Preserve_FEATURE_PANTANAL',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 445, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_PANTANAL'), 
('Rh_Preserve_FEATURE_WHITEDESERT',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 405, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_WHITEDESERT'),

('Rh_Preserve_FEATURE_GOBUSTAN',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 405, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_GOBUSTAN'), -- 1 Production, 3 Culture

('Rh_Preserve_FEATURE_EYE_OF_THE_SAHARA',				'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 225, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_EYE_OF_THE_SAHARA'), -- 2 Production, 1 Science
